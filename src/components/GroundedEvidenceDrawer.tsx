    ...
    <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="text-sm font-bold text-slate-100 uppercase tracking-wider font-mono">
            Retrieved Knowledge & Evidence Grounding (RAG)
          </h3>
        </div>
      ...
      <div className="bg-slate-950/80 border border-cyan-500/30 rounded-xl p-4 space-y-2">
        <div className="flex items-center space-x-2 text-cyan-400 text-xs font-bold font-mono">
          ...
          <span>Grounded AI Briefing (Grounded in Verified Evidence)</span>
        </div>
      ...
      <div className="space-y-3 pt-1">
        <div className="flex items-center justify-between text-xs font-bold text-slate-300">
          <span>Vetted Regulatory & Oceanographic Citations:</span>
          <span className="text-[11px] font-mono text-slate-400">
            {evidence.length} Source Documents Grounded
          </span>
        </div>
